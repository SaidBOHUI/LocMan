...
import banner from '../../assets/banners/road2.jpeg'
...
function AdminHome(){
    ...
    function goToEdit(id){
        return navigate(`/admin/vehicule/${id}`, {state: {id: id}})
    }

    function goToCreate(){
        return navigate('/admin/vehicule/create')
    }
                                    ...
                                    <Table sx={{ minWidth: '80%' }} aria-label="customized table">
                                        <TableHead>
                                            <TableRow>
                                                ...
                                                <StyledTableCell align="left">Prix Jour</StyledTableCell>
                                            ...
                                            <StyledTableRow key={vehicule.plaque}>
                                                ...
                                                <StyledTableCell align="left">									
                                                    <>
                                                        ...
                                                        >
                                                            <DialogContent>
                                                                <img src={vehicule.photo.url} alt="voiture" width='600px' height='300px' style={{textalign:'center'}}/>														
                                                            </DialogContent>
                                                            <DialogActions>
                                                ...
                                                <StyledTableCell align="left">{vehicule.baseFixe} €</StyledTableCell>
                                                <StyledTableCell align="left">{vehicule.prixKm} €</StyledTableCell>
                                                <StyledTableCell align="left">{vehicule.prixJour} €</StyledTableCell>
                                                <StyledTableCell align="left">
